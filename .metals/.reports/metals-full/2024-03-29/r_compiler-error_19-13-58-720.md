...
### file%3A%2F%2F%2FC%3A%2FUsers%2Fuser%2FDesktop%2Fcuarto%2520semestre%2FPFC%2Ftallere3%2Ftaller3%2Fsrc%2Ftest%2Fpruevas.worksheet.sc:81: error: ; expected but integer constant found
    case Logaritmo(e1) => evaluar(e)1 match{
                                    ^
...
def evaluar(f:Expr,a:Atomo,v:Double):Double= f match {
    ...
    case Logaritmo(e1) => evaluar(e)1 match{
        case evaluar(e)<=0 => throw new ArithmeticException("numero menor o igual a 0")
        case e1=>log(evaluar(e1,a,v)) 
}
    }
