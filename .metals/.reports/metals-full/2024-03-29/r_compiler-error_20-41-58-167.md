...
### file%3A%2F%2F%2FC%3A%2FUsers%2Fuser%2FDesktop%2Fcuarto%2520semestre%2FPFC%2Ftallere3%2Ftaller3%2Fsrc%2Ftest%2Fpruevas.worksheet.sc:137: error: ) expected but } found
    } 
    ^
...
def raizNewton(f:Expr,a:Atomo,x0:Double,ba:(Expr,Atomo,Double)=>Boolean):Double={
    if (ba(f,a,x0)) x0 
        ...
        val xi:Double= evaluar(Resta(Numero(x0),Div(f,derivar(f,a))),a,
