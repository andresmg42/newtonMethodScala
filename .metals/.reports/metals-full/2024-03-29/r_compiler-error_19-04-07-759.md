...
### file%3A%2F%2F%2FC%3A%2FUsers%2Fuser%2FDesktop%2Fcuarto%2520semestre%2FPFC%2Ftallere3%2Ftaller3%2Fsrc%2Ftest%2Fpruevas.worksheet.sc:101: error: => expected but } found
    }
    ^
...
def evaluar(f:Expr,a:Atomo,v:Double):Double= f match {
    ...
    case Div(e1, e2) =>(e1,e2) mathc evaluar(e1,a,v)/evaluar(e2,a,v)
