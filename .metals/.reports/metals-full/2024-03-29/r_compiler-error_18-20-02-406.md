...
### file%3A%2F%2F%2FC%3A%2FUsers%2Fuser%2FDesktop%2Fcuarto%2520semestre%2FPFC%2Ftallere3%2Ftaller3%2Fsrc%2Ftest%2Fpruevas.worksheet.sc:85: error: illegal start of simple expression
}
^
...
def limpiar(f:Expr):Expr= f match{
    case Numero(d)=>d
    case Suma(e1,e2) if (e1==Numero(0))=> limpiar(e2) 
    case Suma(e1,e2) if
